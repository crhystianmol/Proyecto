...
public interface NecesidadMapper {
    public void addNecesidad(@Param("emailUser") String emailUser,@Param("categoryId") int categoryId, @Param("name") String name , @Param("description") String description ,  @Param("dateI") Date dateI, @Param("status") String status, @Param("dateM") Date dateM);
